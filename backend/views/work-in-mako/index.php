...
/* @var $searchModel backend\models\search\WorkInMakoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Work In Makos';
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Додати Work In Makos','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Список Work In Makos',
