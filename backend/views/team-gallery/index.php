...
/* @var $searchModel backend\models\search\TeamGallerySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Team Galleries';
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Додати Team Galleries','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Список Team Galleries',
