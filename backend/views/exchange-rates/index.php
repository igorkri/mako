...
/* @var $searchModel backend\models\search\ExchangeRatesSearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                !$is_course ?
                    ...
                    ['role'=>'modal-remote','title'=> 'Додати Exchange Rates','class'=>'btn btn-default'])
                    : ''.
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Список Exchange Rates',
