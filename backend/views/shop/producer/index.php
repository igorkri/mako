...
/* @var $searchModel backend\models\search\shop\ProducerSearch */
...
<div class="producer-index">
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="fas fa-plus"></i>', ['create'],
                        ['role' => 'modal-remote', 'title' => 'Додати виробника', 'class' => 'btn btn-default']) .
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Список виробників',
