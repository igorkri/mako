...
/* @var $searchModel backend\models\search\shop\CategorySearch */
...
<div class="category-index">
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="fas fa-plus"></i>', ['create'],
                        ['role' => 'modal-remote', 'title' => 'Додати категорію', 'class' => 'btn btn-default']) .
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Список категорій',
