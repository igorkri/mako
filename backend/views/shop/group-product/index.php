...
/* @var $searchModel backend\models\search\GroupProductsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Group Products';
...
?>
<div class="group-products-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Додати Group Products','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Список Group Products',
