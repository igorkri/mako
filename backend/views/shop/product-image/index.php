...
/* @var $searchModel backend\models\search\shop\ProductImageSearch */
...
<div class="product-image-index">
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="fas fa-plus"></i>', ['create'],
                        ['role' => 'modal-remote', 'title' => 'Додати Product Images', 'class' => 'btn btn-default']) .
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Список Product Images',
