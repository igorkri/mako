...
/* @var $searchModel backend\models\search\LearningInMakoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Learning In Makos';
...
?>
<div class="learning-in-mako-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Додати Learning In Makos','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Список Learning In Makos',
