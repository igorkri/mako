...
use backend\models\search\shop\SeriesSearch;
...
class SeriesController extends Controller
{
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Create new Series",
                    'content' => '<span class="text-success">Create Series success</span>',
                    'footer' => Html::button('Закрити', ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing Series model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Series model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
