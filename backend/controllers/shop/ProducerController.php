...
use backend\models\search\shop\ProducerSearch;
...
class ProducerController extends Controller
{
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Create new Producer",
                    'content' => '<span class="text-success">Create Producer success</span>',
                    'footer' => Html::button('Закрити', ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing Producer model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Producer model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
