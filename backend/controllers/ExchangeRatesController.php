...
use backend\models\search\ExchangeRatesSearch;
...
class ExchangeRatesController extends Controller
{
    ...
    {    
        ...
        $is_course = ExchangeRates::find()->one();
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new ExchangeRates",
                ...
                return [
                    ...
                    'title'=> "Create new ExchangeRates",
                    'content'=>'<span class="text-success">Create ExchangeRates success</span>',
                    'footer'=> Html::button('Закрити',['class'=>'btn btn-default pull-left','data-bs-dismiss'=>"modal"])
    ...
    /**
     * Delete an existing ExchangeRates model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ExchangeRates model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
