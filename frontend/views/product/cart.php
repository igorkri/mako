                ...
                <div class="goods">
                    <?php foreach ($products as $cart_product): ?>
                        ...
                        <div class="item">
                            <div class="img">
                                <?php if (!isset($d[1])): ?>
                                    <img src="/img/products/<?=$cart_product->getId()?>/<?=$cart_product->productImages[0]->name?>" alt="" width="86">
                                <?php else: ?>
                            ...
                            <div class="description">
                                ...
                                <p class="price"><?= Yii::$app->formatter->asCurrency($cart_product->price) ?> | <?= $cart_product->getQuantity() ?> шт.</p>
                            </div>
                            <div class="delete">
