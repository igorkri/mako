...
<head>
    ...
    <meta name="csrf-token"
        content="PbSrsSrVgCxnyfJjQMEtu7NgPfQPqCcqOpmb2CwjbhMIxMmFE6bNaxKApwp2iFvJnhgMsHb5YG136eKTbVAMJA==">
    ...
    <div class="dark_background" id="dark_background">
        ...
        <div class="modal_window dn" id="sign_up_window">
            ...
            <form action="/order-a-call" method="post" id="order-a-call">
                ...
                <input type="text" name="name" oninvalid="this.setCustomValidity('Укажіть будь ласка Ваше ім’я')"
                    oninput="this.setCustomValidity('')" placeholder="Ваше ім’я" required>
                <input type="text" name="phone" oninvalid="this.setCustomValidity('Укажіть будь ласка Ваш телефон')"
                    oninput="this.setCustomValidity('')" placeholder="Номер телефону" required>
        ...
        <div class="modal_cart dn" id="cart_window">
            ...
            <div id="cart-products" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000">
    ...
    <header id="header">
        ...
        <div class="order visible">
            ...
            <div class="cart">
                ...
                <div id="header-qty-product" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000">
                    <p>
                        0 </p>
                </div>
            </div>
...
>>>>>>> 9487650f58848f02ace8a5b7e2ad9d6f650092c4
</html>