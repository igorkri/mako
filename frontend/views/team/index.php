    ...
    <div class="specialists" id="specialists">
        ...
        <div class="card">
            ...
            <div class="text">
                ...
                <div class="info">
                    <p>Опис спеціальності. Послуг. Освіта</p>
                    <p>Декілька речень, рядків.</p>
                    <p>Послуги чистки обличчя, маски для обличчя з різноманітним ефектом, ін’єкції гіалуронової кислоти,
                        хімічний пілінг.</p>
                </div>
            </div>
